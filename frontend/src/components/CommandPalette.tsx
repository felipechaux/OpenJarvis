...
const CLOUD_PROVIDERS: CloudProvider[] = [
  {
    ...
    models: [
      { id: 'openrouter/openrouter/elephant-alpha', desc: 'Elephant' },
      { id: 'openrouter/google/gemma-4-26b-a4b-it:free', desc: 'Google: Gemma 4 26B A4B  (free)' },
      { id: 'openrouter/google/gemma-4-31b-it:free', desc: 'Google: Gemma 4 31B (free)' },
      { id: 'openrouter/google/lyria-3-pro-preview', desc: 'Google: Lyria 3 Pro Preview' },
      { id: 'openrouter/google/lyria-3-clip-preview', desc: 'Google: Lyria 3 Clip Preview' },
      { id: 'openrouter/nvidia/nemotron-3-super-120b-a12b:free', desc: 'NVIDIA: Nemotron 3 Super (free)' },
      { id: 'openrouter/minimax/minimax-m2.5:free', desc: 'MiniMax: MiniMax M2.5 (free)' },
      { id: 'openrouter/openrouter/free', desc: 'Free Models Router' },
      { id: 'openrouter/arcee-ai/trinity-large-preview:free', desc: 'Arcee AI: Trinity Large Preview (free)' },
      { id: 'openrouter/liquid/lfm-2.5-1.2b-thinking:free', desc: 'LiquidAI: LFM2.5-1.2B-Thinking (free)' },
      { id: 'openrouter/liquid/lfm-2.5-1.2b-instruct:free', desc: 'LiquidAI: LFM2.5-1.2B-Instruct (free)' },
      { id: 'openrouter/nvidia/nemotron-3-nano-30b-a3b:free', desc: 'NVIDIA: Nemotron 3 Nano 30B A3B (free)' },
      { id: 'openrouter/nvidia/nemotron-nano-12b-v2-vl:free', desc: 'NVIDIA: Nemotron Nano 12B 2 VL (free)' },
      { id: 'openrouter/qwen/qwen3-next-80b-a3b-instruct:free', desc: 'Qwen: Qwen3 Next 80B A3B Instruct (free)' },
      { id: 'openrouter/nvidia/nemotron-nano-9b-v2:free', desc: 'NVIDIA: Nemotron Nano 9B V2 (free)' },
      { id: 'openrouter/openai/gpt-oss-120b:free', desc: 'OpenAI: gpt-oss-120b (free)' },
      { id: 'openrouter/openai/gpt-oss-20b:free', desc: 'OpenAI: gpt-oss-20b (free)' },
      { id: 'openrouter/z-ai/glm-4.5-air:free', desc: 'Z.ai: GLM 4.5 Air (free)' },
      { id: 'openrouter/qwen/qwen3-coder:free', desc: 'Qwen: Qwen3 Coder 480B A35B (free)' },
      { id: 'openrouter/cognitivecomputations/dolphin-mistral-24b-venice-edition:free', desc: 'Venice: Uncensored (free)' },
      { id: 'openrouter/google/gemma-3n-e2b-it:free', desc: 'Google: Gemma 3n 2B (free)' },
      { id: 'openrouter/google/gemma-3n-e4b-it:free', desc: 'Google: Gemma 3n 4B (free)' },
      { id: 'openrouter/google/gemma-3-4b-it:free', desc: 'Google: Gemma 3 4B (free)' },
      { id: 'openrouter/google/gemma-3-12b-it:free', desc: 'Google: Gemma 3 12B (free)' },
      { id: 'openrouter/google/gemma-3-27b-it:free', desc: 'Google: Gemma 3 27B (free)' },
      { id: 'openrouter/meta-llama/llama-3.3-70b-instruct:free', desc: 'Meta: Llama 3.3 70B Instruct (free)' },
      { id: 'openrouter/meta-llama/llama-3.2-3b-instruct:free', desc: 'Meta: Llama 3.2 3B Instruct (free)' },
      { id: 'openrouter/nousresearch/hermes-3-llama-3.1-405b:free', desc: 'Nous: Hermes 3 405B Instruct (free)' },
